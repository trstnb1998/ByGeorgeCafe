...
import igButton from '/public/_assets_/images/igButton.png';
import fbButton from '/public/_assets_/images/fbButton.png';
import tikTokButton from '/public/_assets_/images/tikTokButton.png';
